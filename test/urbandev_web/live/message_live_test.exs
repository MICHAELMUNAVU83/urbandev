defmodule UrbandevWeb.MessageLiveTest do
  ...
  @create_attrs %{active: "some active", message: "some message", receiver: "some receiver", serial: "some serial", title: "some title"}
  @update_attrs %{active: "some updated active", message: "some updated message", receiver: "some updated receiver", serial: "some updated serial", title: "some updated title"}
  @invalid_attrs %{active: nil, message: nil, receiver: nil, serial: nil, title: nil}
